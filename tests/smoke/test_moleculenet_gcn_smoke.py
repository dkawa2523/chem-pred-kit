...
def moleculenet_gcn_smoke_artifacts(tmp_path_factory: pytest.TempPathFactory) -> Dict[str, Any]:
    ...
    dataset_key = "esol"
    root = tmp_path_factory.mktemp("moleculenet_gcn_smoke")
    ...
    dataset_run_dir = root / "runs" / "build_dataset" / "moleculenet_gcn_smoke"
    ...
    try:
        ...
        logger = get_logger("moleculenet_gcn_dataset", log_file=dataset_run_dir / "build_dataset.log")
        ...
        train_run_root = root / "runs" / "train" / "moleculenet_gcn"
        ...
        eval_run_root = root / "runs" / "evaluate" / "moleculenet_gcn"
...
def test_moleculenet_gcn_smoke_artifacts(moleculenet_gcn_smoke_artifacts) -> None:
    from src.utils.artifacts import validate_evaluate_artifacts, validate_train_artifacts

    validate_train_artifacts(moleculenet_gcn_smoke_artifacts["train_run_dir"])
    validate_evaluate_artifacts(moleculenet_gcn_smoke_artifacts["eval_run_dir"])
